...
硬约束:宫位/星曜/四化落宫必须逐字引用上方数据,张冠李戴=编造;口语务实,联系命主实际生活场景;直接输出4段,不要开场白不要总结。"""
    ...
    try:
        ...
        # P81: verify的prompt v14(⑤m配偶星性别错配——盘1v46实战:男命断2015"正官年"结婚,
        ...
        _ck_ver = ("v47" if gen_type == "verify"
