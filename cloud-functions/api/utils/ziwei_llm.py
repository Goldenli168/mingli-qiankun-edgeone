    ...
    for line in text.split("\n"):
        ...
        if ok and _sig_rows:
            ...
            if _row0:
                ...
                # ⑤c2 子女类:该年必须至少占1个子女信号(子女星/命入子女/四化入子女)
                # P82v19再收紧:红鸾/天喜单信号豁免条款废除——盘2 2014甲午(天喜+命入福德+无子女信号)
                # =真实添丁 vs 盘3 2012壬辰(天喜+命入福德+无子女信号)=实锤无小孩(2025孕但流产),
                # 同结构两样本结果相反=天喜单信号无判别力;宁可漏报不可错报(错报毁反馈信任)
                if ok and _re.search(r"生子|添丁|怀孕|生育|得子|得女|二胎", claim):
                    ...
                    if not _child_sig:
                        ok = False; _why0.append("该年无子女合格信号(须子女星年/命入子女/四化入子女;红鸾/天喜单信号无判别力,严禁凭此断添丁)")
...
- 子女(怀孕/生育): 合格信号仅①子女星年(男命正官/七杀年、女命食神/伤官年) ②流年命入子女宫或四化入子女宫——①②至少占1个才能断添丁。生育断语年份必须晚于结婚断语年份(不主动断未婚先孕)。⚠️红鸾/天喜动不是添丁信号——单有红鸾/天喜(①②全无)的年份严禁断添丁:同为"天喜年+命入福德+无子女信号",一个盘真实添丁、另一个盘实锤无小孩,同结构结果相反=该信号无判别力(实锤教训:某女命盘2012壬辰=天喜动+命入福德被误断"生子添丁",命主至今无小孩;2018戊戌=红鸾年+权太阴入夫妻被误断"怀孕生子",应的是婚恋)。⚠️比选规则:生子添丁多个候选年时,"子女星年+红鸾/天喜动或命入子女宫"权重高于"子女星年+化曜入子女宫"(实锤教训:2014甲午七杀+天喜动+命入子女=三信号齐聚=真实得子年,2015乙未正官+紫微化科入子女被误选,年份偏1)
...
「2012壬辰年生子添丁」(该年=天喜动+命入福德宫,但无子女星/命入子女/化曜入子女)(错:红鸾/天喜单信号无判别力——同为天喜年+命入福德,一个盘真实添丁另一个盘实锤无小孩;添丁必须子女星年/命入子女/四化入子女至少占1个)
...
- 兄弟宫看手足缘分:主星明朗=有手足且得力,空宫借对宫或煞星聚集=手足缘薄或聚少离多。⚠️措辞红线(盘4用户实锤):兄弟宫主星无煞(如贪狼文曲同宫)时,"缘薄/疏离/保持距离"类重判词严禁使用——孤辰/天刑等小星最多支持"物理距离"表述(住校/异地/各自忙),感情厚薄以主星+四化为准:主星无煞=感情好,即使见面少也只能说"聚少但亲"。实测教训:某盘兄弟宫贪狼文曲无煞,被孤辰天刑带偏断"手足缘薄疏离宜保持距离",实际兄妹感情很好只是哥哥住校聚少、玩耍会吵闹(正常兄妹)——"聚少"蒙对,"缘薄"方向性错误。还要区分:吵闹=亲密的表现形式,不是缘薄
